...
class SMTProofsTest extends TacticTestBase {
  ...
  // "SmtLibReader" should "read forward proof examples" in {
  //   round trip "P".asFormula
  //   round trip "Q".asFormula
  //   round trip "P|Q".asFormula
  //   round trip "P|P".asFormula
  //   round trip "P=>(P|Q)".asFormula
  // }
